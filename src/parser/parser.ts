...
import { setLanguage, makeMatrix } from '../helpers';
...
import {
    ...
    ParsedBoardCell,
    GBBParserOptions,
    defaultGBBParserOptions
} from './models';

export const parse = (data: string, options?: Partial<GBBParserOptions>): Board => {
    const fullOptions = Object.assign({}, defaultGBBParserOptions, options) as GBBParserOptions;
